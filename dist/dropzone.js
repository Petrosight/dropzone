...
var $6mU8w$swchelperscjs_define_propertycjs = require("@swc/helpers/cjs/_define_property.cjs");
...
var $a601ff30f483e917$export$2e2bcd8739ae039 = /*#__PURE__*/ function(Emitter1) {
    ...
    function Dropzone(el, options) {
        ...
        var _this;
        _this = (0, $6mU8w$swchelperscjs_call_supercjs._)(this, Dropzone), (0, $6mU8w$swchelperscjs_define_propertycjs._)(_this, "_processedFolders", void 0);
        var fallback, left;
        _this.element = el;
    ...
    (0, $6mU8w$swchelperscjs_create_classcjs._)(Dropzone, [
        ...
        },
        {
            ...
            value: function _addFilesFromDirectory(directory, path) {
                var _this = this;
                var _this__processedFolders;
                var dirReader = directory.createReader();
                if (!((_this__processedFolders = this._processedFolders) === null || _this__processedFolders === void 0 ? void 0 : _this__processedFolders[path])) this._processedFolders[path] = 0;
                            ...
                            try {
                                for(var _iterator = entries[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true){
                                    ...
                                    if (entry.isFile) entry.file(function(file) {
                                        ...
                                        _this._processedFolders[path]++;
                                        return _this.addFile(file);
                                    });
                                    else if (entry.isDirectory) {
                                        _this._processedFolders[path]++;
                                        _this._addFilesFromDirectory(entry, "".concat(path, "/").concat(entry.name));
                                    }
                                }
                            } catch (err) {
                                _didIteratorError = true;
...
var $a601ff30f483e917$var$ExifRestore = /*#__PURE__*/ function() {
    ...
    function ExifRestore() {
        (0, $6mU8w$swchelperscjs_class_call_checkcjs._)(this, ExifRestore);
    }
    (0, $6mU8w$swchelperscjs_create_classcjs._)(ExifRestore, null, [
        {
            key: "initClass",
            value: function initClass() {
